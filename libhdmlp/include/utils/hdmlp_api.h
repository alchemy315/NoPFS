...
extern "C" {
Prefetcher* pf[PARALLEL_JOBS_LIMIT];    // 当前node中prefetcher指针的数组
bool used_map[PARALLEL_JOBS_LIMIT] = {false};  // 被使用的job_id
unsigned long long int consumed_until[PARALLEL_JOBS_LIMIT] = {0}; // 当前正在使用的文件末端
