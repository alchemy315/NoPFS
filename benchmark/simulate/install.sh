...
--name torchtest \
--net=host \
-v /home/zzp/code/NoPFS/:/home/zzp/code/NoPFS/ \
--rm \
-it \
-d \
torchtest:latest
# sudo docker container exec -it torchtest /bin/bash
...
# 11.环境变量
echo -e "export PKG_CONFIG_PATH=\$PKG_CONFIG_PATH:/usr/local/opencv/lib/pkgconfig\n\
...
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/hdf5/lib" | sudo tee ~/.bashrc
source ~/.bashrc
